 ...
 */
require_once dirname(dirname(dirname(__FILE__))) . '/config/system_config.php';
require_once PATH_CONFIG.'user_config.php';
...
class Mysql
{
    ...
    {
        $this->link = mysql_connect(DB_HOST, DB_USERNAEM, DB_PASSWORD, DB_NAME, DB_PORT)
        or
